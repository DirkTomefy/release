...
VALUES (2, '2019-07-05', '2021-06-15', 1800.00, 2200.00, 120);

-- Bovin 3 : acheté le 2021-01-20, vendu le 2022-03-10, prix achat 1200, prix vente 1600
INSERT INTO bovin (id_race, date_achat, date_vente, prix_achat, prix_vente, poids_achat) 
VALUES (3, '2021-01-20', '2022-03-10', 1200.00, 1600.00, 95);

-- Bovin 4 : acheté le 2022-06-14, pas encore vendu, prix achat 950
INSERT INTO bovin (id_race, date_achat, date_vente, prix_achat, prix_vente, poids_achat) 
VALUES (4, '2022-06-14', NULL, 950.00, NULL, 88);

-- Bovin 5 : acheté le 2023-09-01, pas encore vendu, prix achat 1100
INSERT INTO bovin (id_race, date_achat, date_vente, prix_achat, prix_vente, poids_achat) 
VALUES (5, '2023-09-01', NULL, 1100.00, NULL, 92);

-- Bovin 6 : acheté le 2020-11-20, vendu le 2021-12-01, prix achat 1400, prix vente 1850
INSERT INTO bovin (id_race, date_achat, date_vente, prix_achat, prix_vente, poids_achat) 
VALUES (6, '2020-11-20', '2021-12-01', 1400.00, 1850.00, 105);

-- Bovin 7 : acheté le 2018-08-25, pas encore vendu, prix achat 2000
INSERT INTO bovin (id_race, date_achat, date_vente, prix_achat, prix_vente, poids_achat) 
VALUES (7, '2018-08-25', NULL, 2000.00, NULL, 130);

-- Bovin 8 : acheté le 2021-05-10, vendu le 2023-02-28, prix achat 1600, prix vente 2100
INSERT INTO bovin (id_race, date_achat, date_vente, prix_achat, prix_vente, poids_achat) 
VALUES (8, '2021-05-10', '2023-02-28', 1600.00, 2100.00, 115);

-- Bovin 9 : acheté le 2022-10-03, pas encore vendu, prix achat 780
INSERT INTO bovin (id_race, date_achat, date_vente, prix_achat, prix_vente, poids_achat) 
VALUES (1, '2022-10-03', NULL, 780.00, NULL, 82);

-- Bovin 10 : acheté le 2023-02-15, pas encore vendu, prix achat 1300
INSERT INTO bovin (id_race, date_achat, date_vente, prix_achat, prix_vente, poids_achat) 
VALUES (2, '2023-02-15', NULL, 1300.00, NULL, 98);

-- Ajout de quelques bovins supplémentaires pour avoir plus de données
INSERT INTO bovin (id_race, date_achat, date_vente, prix_achat, prix_vente, poids_achat) 
VALUES (3, '2020-09-05', '2022-08-12', 1750.00, 2300.00, 125);

INSERT INTO bovin (id_race, date_achat, date_vente, prix_achat, prix_vente, poids_achat) 
VALUES (4, '2023-01-20', NULL, 1200.00, NULL, 96);

INSERT INTO bovin (id_race, date_achat, date_vente, prix_achat, prix_vente, poids_achat) 
VALUES (5, '2021-11-15', '2023-05-01', 900.00, 1300.00, 90);

INSERT INTO bovin (id_race, date_achat, date_vente, prix_achat, prix_vente, poids_achat) 
VALUES (6, '2019-12-10', NULL, 1600.00, NULL, 110);

INSERT INTO bovin (id_race, date_achat, date_vente, prix_achat, prix_vente, poids_achat) 
VALUES (7, '2022-04-22', NULL, 1100.00, NULL, 94);
